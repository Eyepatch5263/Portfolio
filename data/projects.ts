...
export const projects: Project[] = [
    {
        ...
        technologies: ["Next.js", "TypeScript", "Node.js", "PostgreSQL", "Supabase", "NextAuth.js", "Redis", "yjs", "TipTap", "Tanstack-Query", "Shadcn UI", "Mdx", "Websockets", "Tailwind CSS", "Resend", "Amazon-Poly", "Amazon-S3"],
        featured: true,
    ...
    },
    {
        ...
        problem:
            "Finding an anime based on intent beyond keywords is hard. This app helps users discover new animes based on certain emotional arc, themes, or characters personality.",
        impact: "Anima helps users discover new anime based on their preferences.",
        technologies: ["Next.js", "Express.js", "TypeScript", "graphql", "PostgresSQL", "ollama", "huggingface-models", "qdrant", "RAG", "Docker", "Digital Ocean", "Tanstack-Query", "Tailwind CSS", "Codegen"],
        featured: true,
        github: "https://github.com/Eyepatch5263/anima",
        demo: "https://anima.pratyush.works"
    },
    // {
    //     id: "proj-4",
    //     slug: "onlyanime",
