                    ...
                    <div className="space-y-16">
                        ...
                        {projectArchitecture[slug] && (
                            ...
                            >
                                ...
                                <ArchitectureDiagram
                                    nodes={projectArchitecture[slug].nodes}
                                    connections={projectArchitecture[slug].connections}
                                />
                        ...
                        >
                            ...
                            {mode === "recruiter" ? (
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <CardTitle className="text-lg">{slug == 'explain-bytes' ? "Schema Design" : "Database Schema"}</CardTitle>
                                        </CardHeader>
                                        <CardContent>
                                            <pre className="p-4 rounded-lg bg-secondary overflow-x-auto text-sm">
