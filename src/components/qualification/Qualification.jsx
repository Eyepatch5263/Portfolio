            ...
            <div className="qualification__container container">
                <div className="qualification__tabs">
                    <div className={toggleState === 1 ? "qualification__button qualification__active button--flex" : "qualification__button  button--flex"} onClick={() => { toggleTab(1) }}>
                        ...
                        <i className="fas fa-graduation-cap qualification__icon qualification__calender"></i>
                        Education
                    </div>

                    <div className={toggleState === 2 ? "qualification__button qualification__active button--flex" : "qualification__button  button--flex"} onClick={() => toggleTab(2)}>
                        <i className="fas fa-briefcase qualification__icon qualification__calender"></i>
                        Experience
                    </div>
                </div>
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <div className="qualification__calender">
                                    <i className="fas fa-calendar-alt qualification__calender"></i>
                                    2022 - present
                                </div>
                            </div>
                            <div>
