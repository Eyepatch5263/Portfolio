...
export const projectArchitecture: Record<string, { nodes: ArchitectureNode[]; connections: ArchitectureConnection[] }> = {
    ...
    "codilio": {
        nodes: [
            { id: "client", label: "Next.js + Monaco", type: "frontend" as const, x: 15, y: 50, description: "Frontend featuring Monaco Editor and Clerk for secure authentication and profile management." },
            { id: "clerk", label: "Clerk Auth", type: "external" as const, x: 40, y: 20, description: "Managed authentication service providing JWTs and user profile management." },
            { id: "convex", label: "Convex", type: "backend" as const, x: 50, y: 45, description: "Reactive serverless backend handling database mutations, snippet persistence, and real-time state sync." },
            { id: "piston", label: "Piston API", type: "external" as const, x: 85, y: 30, description: "High-performance code execution engine supporting 20+ programming languages." },
            { id: "lemon", label: "Lemon Squeezy", type: "external" as const, x: 85, y: 70, description: "Merchant of Record handling global payments, tax compliance, and subscription lifecycles." },
        ],
        connections: [
            { from: "client", to: "clerk", label: "Auth" },
            { from: "clerk", to: "convex", label: "Webhook Sync", animated: true },
            { from: "client", to: "convex", label: "Reactive Sync", animated: true },
            { from: "convex", to: "piston", label: "Execute Code" },
            { from: "convex", to: "lemon", label: "Webhooks" },
            { from: "client", to: "lemon", label: "Checkout" },
        ],
    },
    "onlyanime": {
        nodes: [
